...
router.post('/journal-entry-corrections', async (req: Request, res: Response) => {
  try {
...
router.get('/journal-entry-corrections/count', async (req: Request, res: Response) => {
  try {
    const authUser = (req as AuthenticatedRequest).user;
...
router.put('/journal-entry-corrections/mark-suggested', async (req: Request, res: Response) => {
  try {
    const authUser = (req as AuthenticatedRequest).user;
...
router.get('/excluded-entries', async (req: Request, res: Response) => {
  try {
    const authUser = (req as AuthenticatedRequest).user;
