// データベースモデル型定義 — 全テーブルの TypeScript 型・API レスポンス型・フォーム型
...
export interface Document {
  ...
  doc_classification?: Record<string, unknown> | null;
...
// domain 層の正本型を re-export（重複定義を排除）
export type { DuplicateCheckResult } from '../../domain/document/duplicate-checker.js';
export type { BalanceCheckResult } from '../../domain/accounting/balance-validator.js';
export type { ReceiptDuplicateResult } from '../../domain/document/duplicate-checker.js';
export type { SupplierMatchResult } from '../../domain/document/supplier-matcher.js';
